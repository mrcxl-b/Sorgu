...
module.exports = {
    ...
    description: "gsm numarasından tc bilgileri", //the command description for Slash Command Overview
    cooldown: 1.5,
    ...
    run: async (client, interaction) => {
        ...
        const { guild } = member;
            ...
            //
            con.query(`SELECT * FROM tcgsm WHERE gsm="${adx}"`, function (err, result) {
